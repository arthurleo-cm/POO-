...
diasemana = I % 7
  ...
  Você foi escolhido(a) para desenvolver o algoritmo e efetuar a implementação em JAVA,   de um software, utilizando paradigma de orientação a objetos, incorporando, pelo menos,   os seguintes métodos:
  
  setDiaCorrente(dd)
  setMesCorrente(mm)
  setAnoCorrente(aaaa)
  setDataCorrente(dd,mm,aaaa)
  calcularDiaSemana()
...
class DIASEMANA
{
    private: int dia,mes,ano,diasemana;
    
    
    public: void setDataCorrente(int d,int m,int a)
    {
        dia=d;
        mes=m;
        ano=a;
...
int main()
{
    ...
    ds = diasemana.calcularDiaSemana();
